...
public class fitnessGoals extends JFrame implements ActionListener {
    ...
    fitnessGoals() {
        ...
        txtArWeight = new JTextArea();
        txtArWeight.setBounds(80, 360, 510, 200);
        txtArWeight.setFont(new Font("Courier", Font.PLAIN, 20));
        txtArWeight.setEditable(false);
        add(txtArWeight);
        ...
        if (e.getSource() == btnConfirm) {
            ...
            try {
                ...
                if (doubleWeight > 0 && doubleHeight > 0) {
                    ...
                    txtArWeight.setText(doubleWeight + " " + cmbWeightUnits.getSelectedItem() + "\n" +
